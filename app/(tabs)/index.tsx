...
import { Image, StyleSheet, TextInput, TouchableOpacity, Alert, View, Text,Pressable } from 'react-native';
    ...
    <View style={styles.container}>
      <ThemedView style={styles.contentContainer}>
        ...
        <ThemedView style={styles.formContainer}>
          ...
          <Pressable
               onPress={() => router.push('/screens/EmployeePortal')}
               onHoverIn={() => setIsHovered(true)}
               onHoverOut={() => setIsHovered(false)}
             >
          <Text style={[styles.employeePortal, isHovered && styles.hoveredPortal]} onPress={() => router.push('/screens/EmployeePortal')}>
            Employee Portal
          </Text>
         </Pressable>
        </ThemedView>
...
employeePortal: {
  ...
  textDecorationLine: 'underline',
  fontSize: 16,
  marginTop: -20, // Optional: adjust spacing if needed
  marginBottom: 10,
},
...
export default function HomeScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      router.replace('/screens/TouchScreen');
    } catch (error) {
      ...
      <ThemedView style={styles.contentContainer}>
        ...
        <ThemedView style={styles.formContainer}>
          ...
          >
            <Text
              style={[
                styles.employeePortal,
                isHovered && styles.hoveredPortal,
              ]}
            >
              Employee Portal
            </Text>
